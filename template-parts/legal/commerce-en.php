...
?>
<h1 class="legal-page-title"><?php esc_html_e('Commerce disclosure', 'antiques-marketplace'); ?></h1>
<p class="legal-muted"><?php esc_html_e('Last updated: April 18, 2026', 'antiques-marketplace'); ?></p>
...
<p class="legal-lead">This page gives the information we show customers before and when they pay online. It follows the same kind of layout used on professional services and platform terms (clear identification of the seller, how and when charges occur, and how refunds work), consistent with
	...
	<a href="<?php echo esc_url(antiques_marketplace_page_link('terms-of-service')); ?>"><?php esc_html_e('Terms of Service', 'antiques-marketplace'); ?></a> and
	<a href="<?php echo esc_url(antiques_marketplace_page_link('privacy-policy')); ?>"><?php esc_html_e('Privacy Policy', 'antiques-marketplace'); ?></a>.</p>

<h2>Seller / operator</h2>
<ul>
	<li><strong>Site / brand name:</strong> <?php echo esc_html(get_bloginfo('name')); ?></li>
	<li><strong><?php esc_html_e('Legal Name:', 'antiques-marketplace'); ?></strong> Akira Washiya | 鷲谷彬</li>
	<li><strong><?php esc_html_e('Company Name:', 'antiques-marketplace'); ?></strong> 有限会社鳥海メディカルサービス</li>
	<li><strong><?php esc_html_e('Head of Operations:', 'antiques-marketplace'); ?></strong> Akira Washiya</li>
	<li><strong><?php esc_html_e('Company Number (法人番号):', 'antiques-marketplace'); ?></strong> 2060002006021</li>
	<li><strong><?php esc_html_e('Address:', 'antiques-marketplace'); ?></strong> 栃木県宇都宮市一条３丁目２番２９号レオパレス２１－１０２号室</li>
	<li><strong><?php esc_html_e('Phone:', 'antiques-marketplace'); ?></strong> <a href="tel:08012292520">080-1229-2520</a></li>
	...
	<li><strong><?php esc_html_e('Email:', 'antiques-marketplace'); ?></strong> <a href="mailto:<?php echo esc_attr(get_bloginfo('admin_email')); ?>"><?php echo esc_html(get_bloginfo('admin_email')); ?></a></li>
</ul>
...
<h2>Privacy</h2>
<p>Our <a href="<?php echo esc_url(antiques_marketplace_page_link('privacy-policy')); ?>"><?php esc_html_e('Privacy Policy', 'antiques-marketplace'); ?></a> explains how we handle personal data. Card data is processed by Stripe under its terms and security practices.</p>

<h2><?php esc_html_e('Terms of Service', 'antiques-marketplace'); ?></h2>
<p>Purchases are also governed by our
	<a href="<?php echo esc_url(antiques_marketplace_page_link('terms-of-service')); ?>"><?php esc_html_e('Terms of Service', 'antiques-marketplace'); ?></a>, including limitations of liability and governing law.</p>
