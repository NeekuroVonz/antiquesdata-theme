...
?>
<h1 class="legal-page-title"><?php esc_html_e('Privacy Policy', 'antiques-marketplace'); ?></h1>
<p class="legal-muted"><?php esc_html_e('Last updated: April 18, 2026', 'antiques-marketplace'); ?></p>

<h2><?php esc_html_e('Introduction', 'antiques-marketplace'); ?></h2>
...
<h2><?php esc_html_e('Other policies', 'antiques-marketplace'); ?></h2>
<p>This Privacy Policy works together with our
	...
	<a href="<?php echo esc_url(antiques_marketplace_page_link('commerce-disclosure')); ?>"><?php esc_html_e('Commerce disclosure', 'antiques-marketplace'); ?></a>. If there is a conflict, we will resolve it reasonably; specific written contracts for a transaction may control how we handle certain data under that contract.</p>
...
<h2><?php esc_html_e('Contact us', 'antiques-marketplace'); ?></h2>
<p><strong><?php esc_html_e('Legal Name:', 'antiques-marketplace'); ?></strong> Akira Washiya | 鷲谷彬<br>
	<strong><?php esc_html_e('Company Name:', 'antiques-marketplace'); ?></strong> 有限会社鳥海メディカルサービス<br>
	<strong><?php esc_html_e('Head of Operations:', 'antiques-marketplace'); ?></strong> Akira Washiya<br>
	<strong><?php esc_html_e('Company Number (法人番号):', 'antiques-marketplace'); ?></strong> 2060002006021<br>
	<strong><?php esc_html_e('Address:', 'antiques-marketplace'); ?></strong> 栃木県宇都宮市一条３丁目２番２９号レオパレス２１－１０２号室<br>
	<strong><?php esc_html_e('Phone:', 'antiques-marketplace'); ?></strong> <a href="tel:08012292520">080-1229-2520</a><br>
	<strong><?php esc_html_e('Email:', 'antiques-marketplace'); ?></strong> <a href="mailto:<?php echo esc_attr(get_bloginfo('admin_email')); ?>"><?php echo esc_html(get_bloginfo('admin_email')); ?></a></p>
